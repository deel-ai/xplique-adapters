"""
RetinaNet latent data extraction for concept-based explanations.

This module provides components for extracting and manipulating latent representations
from RetinaNet object detection models for use with Xplique's concept-based
explanation methods.

See https://docs.pytorch.org/vision/main/_modules/torchvision/models/detection/retinanet.html
...
class RetinanetExtractorBuilder(LatentExtractorBuilder):
    ...
    def build(
        ...
        extraction_layer
            Index specifying which feature layer to use as activations. Default is -1.
        ...
        def h(self, latent_data: LatentDataRetinanet):
            ...
            anchors_per_loc = hwa // hw_total
            num_anchors_per_level = [
                hw * anchors_per_loc for hw in num_anchors_per_level
            ]
